...
class Spiro:
    ...
    def __init__(self, xc, yc, col, R, r, l):
        ...
        # set the parameters
        self.setparames(xc, yc, col, R, r, l)

        # initialize the drawing
        self.restart()

    # set the parameters
    def setparames(self, xc, yc, col, R, r, l):
...
When run with on arguments, this program draws random Spirographs.
...
if args.sparams:
    parser = [float(x) for x in args.sparams]

...
# 此时会打开pdb调试，注意：先使用 s 跳转到这个 pdbTest 函数中，然后就可以使用 l 看到代码了
# pdb.run('pdbTest(3)')
...
# 《9 执行到函数的最后一步》
# r----->如果在函数中不想一步步的调试了，只是想到这个函数的最后一条语句那个位置，比如return语句，
# 那么就可以使用r；r表示return的意思
